namespace SpeedometerDemo.Data
{
    public struct CarInfoData
    {
        ...
        public const int EngineAcceleration = 10;
        public const int EngineDeceleration = 5;
        public const int EngineBraking = 20;
        public const int NitroSpeedMultiplier = 3;
        public const int NitroUsingSpeed = 5;
        public const int NitroChargingSpeed = 1;
        public const int FlashChargingSpeed = 1;
        public const int FlashChargeCapacity = 5000;
